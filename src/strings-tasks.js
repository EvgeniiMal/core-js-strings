...
function sumOfCodes(str) {
  if (!str) return 0;
  return Array.from(str).reduce((prev, curr) => prev + curr.charCodeAt(0), 0);
}
...
function orderAlphabetically(str) {
  ...
  return strArr.sort((a, b) => a.charCodeAt(0) - b.charCodeAt(0)).join('');
}
...
function countVowels(str) {
  const vowelsCount = str.match(/[aeiouy]/gi);
